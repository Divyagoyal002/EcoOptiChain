...
const DealsBanner = () => (
  ...
  <div className="w-full p-6 flex overflow-hidden shadow rounded-lg">
    ...
    {/* Right: Greenmart+ Deal */}
    <div className="bg-[#ffd600] w-full max-w-[340px] flex flex-col justify-center p-4">
      <div className="flex items-center mb-2">
        <span className="font-bold text-[#0071dc] mr-2 bg-white px-2 py-1 rounded">Greenmart</span>
        <span className="font-bold text-[#0071dc]">DEALS</span>
      </div>
      <div className="font-bold text-[#002d58] mb-1">Get 50% off Greenmart+</div>
      <div className="text-xs text-[#002d58] mb-2">Save big on an annual plan now.</div>
      <button className="bg-[#0071dc] text-white text-xs font-bold px-3 py-1 rounded">Join Greenmart+</button>
    </div>
  </div>
);
